...
#Practicing string methods. Exercise 1:
...
highlighted_poems_stripped = [poem_stripped.strip() for poem_stripped in highlighted_poems_list]
...
#Practicing string methods. Exercise 2:
...
float_sales = [float(sale.strip("$")) for sale in sales]

total_sales = sum(float_sales)
